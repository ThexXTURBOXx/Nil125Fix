package de.femtopedia.nil125fix.nei;
...
public class FRHSPTransformer extends MiniPlusTransformer {
    ...
    @Patch.Method("<init>(Lcodechicken/nei/FurnaceRecipeHandler;Lnet/minecraft/src/ItemStack;Lnet/minecraft/src/ItemStack;)V")
